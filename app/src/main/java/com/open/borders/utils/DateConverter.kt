...
//        }
    ...
    fun jDate1(date_string: String): String {
...
//        callback: (Long) -> Unit
    ...
    fun getMMDDYYYY(date_string: String): String {
//        val input = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", Locale.getDefault())
    ...
    fun getHHMM(date_string: String): String {
//        val input = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", Locale.getDefault())
        val dateFormat = SimpleDateFormat("yyyy-MM-dd", Locale.getDefault())
        val myDate: Date
        myDate = try {
...
//        return timeFormat.format(myDate)
    ...
    fun getTimeWithAmPmInSmall(date_string: String): String {
        val dateFormat = SimpleDateFormat("HH:mm", Locale.getDefault())
        val myDate: Date
        myDate = try {
            dateFormat.timeZone = TimeZone.getTimeZone("UTC");
    ...
    fun getDynamicTime(format: String, date_string: String): String {
    ...
    fun getRemainingTime(format: String, date_string: String, context: Context): String {
        var millisToAdd = 86400000
        val dateFormat = SimpleDateFormat(format, Locale.getDefault())
        val myDate: Date = try {
            dateFormat.timeZone = TimeZone.getTimeZone("UTC")
        ...
        myDate.time = myDate.time + millisToAdd;
        val millis = myDate.time - Calendar.getInstance().time.time

        Log.e("mill", kotlin.math.abs(millis).toString())

//        val timeFormat = SimpleDateFormat("hh:mm a", Locale.getDefault())
//        return timeFormat.format(myDate)
        var ago = convertSecondsToHMmSs(millis / 1000) ?: ""
        Log.e("mill", ago)
        return ago
    }
    ...
    fun convertSecondsToHMmSs(seconds: Long): String? {
        ...
        return String.format("%d Hr(s) %02d Min(s) left to connect", h, m)
    }
