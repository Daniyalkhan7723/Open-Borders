package com.open.borders.thirdPartyModules.tabflashyAnmation;
...
public class TabFlashyAnimator extends ViewPager.SimpleOnPageChangeListener {
    ...
    public TabFlashyAnimator(TabLayout tabLayout, BaseActivity baseActivity, Typeface fontRegular) {
    ...
    private void getTabView(int position, TabLayout.Tab tab, boolean isSelected) {
        ...
        set.applyTo(layout);
        tabImageView.setColorFilter(Color.argb(255, 191, 174, 152));
    }
...
//        ((HomeHost) baseActivity).highlightIndicator(position);
//        switch (position){
//            case 0  :{
//            break;}
//            case 1  :{ break;}
