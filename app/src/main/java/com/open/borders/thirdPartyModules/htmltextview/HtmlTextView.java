...
private Context context = null;
    ...
    public void setHtml(@NonNull String html) {
        setHtml(html, null, (BaseActivity) context );
    }
    ...
    public void setHtml(@RawRes int resId, @Nullable Html.ImageGetter imageGetter) {
        ...
        setHtml(convertStreamToString(inputStreamText), imageGetter,(BaseActivity) context );
    }
     ...
     *                    HtmlLocalImageGetter and HtmlRemoteImageGetter
     */
    public void setHtml(@NonNull String html, @Nullable Html.ImageGetter imageGetter, BaseActivity baseActivity) {
        Spanned styledText = HtmlFormatter.formatHtml(
                ...
                }, indent, removeTrailingWhiteSpace, baseActivity
        );
